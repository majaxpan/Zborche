...
namespace Zborche
{
    public partial class Zborche : Form
    {
        ...
        //public static readonly int MAX_TRIES { get; set; } = 5;
        public Zborche()
        {
            InitializeComponent();
            Init();
        ...
        {
            DialogResult result = MessageBox.Show("Game Over. Do you want to play again?", "Prompt", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
